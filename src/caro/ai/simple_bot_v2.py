...
from caro.ai.min_max_v2 import minimax
from caro.ai.alpha_beta_v2 import alpha_beta
...
def choose_best_move(board, depth = 2):
    ...
    # Xóa cache cũ
    from caro.ai.min_max_v2 import TRANSPOSITION_TABLE_MINIMAX
...
def choose_best_move_alpha_beta(board, depth = 4):
    ...
    # Xóa cache cũ
    from caro.ai.alpha_beta_v2 import TRANSPOSITION_TABLE
