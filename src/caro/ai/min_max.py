...
def minimax(board, depth, is_maximizing):
    ...
    if is_maximizing:
        ...
        for move in get_potential_moves(board):
            ...
            score = minimax(board, depth - 1, True) # Đệ quy xuống lượt Bot
            undo_move(board, move)
